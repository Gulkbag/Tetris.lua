...
init_audio = function ()
    for i, v in pairs(audiofiles) do 
        audio[v] = love.audio.newSource('sound/'..v..'.ogg', 'static');
    end
end
...
rules = {   
    ...
    soft_gravity = {delay = 3, distance = 1}
}
...
game = {
    ...
    hold_timer = 1,
    gravity = 1,
    gravities = {{delay = rules.num_levels, distance = 1}, rules.soft_gravity},
    hold_dir = 0,
    lines_to_remove = {},
    score = 0,
    level = 1,
